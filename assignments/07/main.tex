...
\end{exercise}
\begin{solution}
    Nechť $G = (V,E)$ je souvislý neorientovaný graf. Víme, že symetrická diference dvou různých řezů je opět řez. Důkaz provedeme indukcí dle velikosti řezu $|K|$. Nechť $K$ je libovolný řez.
    \begin{enumerate}[1)]
