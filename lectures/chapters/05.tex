...
\begin{itemize}
    \item Základní krok. $k=0$, tj. $m=n$. Takže se jedná o \hyperref[kruznice]{cyklus}. Všechny vrcholy cyklu mají 
    stupeň 2.
...
právě tehdy, když existuje netriviální orientovaná \hyperref[stc]{cesta} z $u$ do $v$.
...
$j - i$. \\ \ii{BÚNO}: $e \in (E_1 \setminus E_2)$, tedy $e \not\in E_2$, ale $e \in E_2^t$. Tj. musí existovat v $G_2$ 
\hyperref[stc]{cesta} z $v_i$ do $v_j$, která má alespoň 2 hrany.
\begin{equation}
