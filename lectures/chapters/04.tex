...
\dukaz\\
\ii{Pomocná definice}. Množina $A$ je nezávislá $A \subseteq V(G)$ pokud pro každou $e = \bc{u, v}$, jestliže $u \in A$, 
...
\end{equation}
\dukaz Vezměme graf $G$ bez $K_{r+1}$ s nejméně hranami (přidáním hrany by vznikl $K_{r+1}$). Tedy $G$ má $K_r$.
